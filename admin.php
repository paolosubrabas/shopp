...
<?php include('include/admin/header.php');?>
    ...
    <div class="col-sm-9 padding-right">
					...
					<a rel="facebox" href="addproduct.php">Add Service</a>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><a rel="facebox" href="editproductimage.php?id='.$row['ID'].'"><img src="reservation/img/products/'.$row['imgUrl'].'" width="80" height="60"></a></td>';
