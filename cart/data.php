...
class Shopping {
    ...
    function checkout(){
        ...
        //$text =
        $str1="Hi ";
         $str2="Your reservation:";
         $str3="total amount:";

//echo $text;
//echo $number;

exec('echo '.$str1.''.$fname.' '.$str2.'  '.$item.' '.$str3.' '.$price.' | gnokii --sendsms '.$contact);
        ...
        $q = "INSERT INTO dbgadget.order(id,name,contact,address,email,item,amount,status,reserveDate,dateRequested,dateConfirmed) VALUES (NULL, '$fullname', '$contact', '$address', '$email', '$item', '$amount', 'unconfirmed','$reserveDate', '$date', '')";
