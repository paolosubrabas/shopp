    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="catering-form">
				    	...
				    	<form id="main-catering-form" class="catering-form row" name="catering-form" method="post" action="sendparty.php">
				            ...
				            <div class="form-group col-md-6">
				                <input type="text" name="subject" class="form-control" required placeholder="Party Theme">
				            </div>
				            <div class="form-group col-md-6">
				                <input type="text" name="type" class="form-control" required placeholder="Party Type">
				            </div>
				            ...
				            <div class="form-group col-md-6">
				                <input type="text" name="time" class="form-control" required placeholder="Time Neded">
				            </div>  
				             <div class="form-group col-md-6">
				                <input type="text" name="pname" class="form-control" required placeholder="Venue">
				            </div>                
				            <div class="form-group col-md-12">
